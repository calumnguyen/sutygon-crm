...
function tabReducer(state: TabState, action: TabAction): TabState {
  switch (action.type) {
    ...
    case 'REMOVE_FIRST_LEVEL_TAB':
      const updatedFirstLevelTabs = state.firstLevelTabs.filter(
        tab => tab.id !== action.payload
      );
      return {
        ...state,
        firstLevelTabs: updatedFirstLevelTabs,
        activeFirstLevelTab: state.activeFirstLevelTab?.id === action.payload
    ...
    case 'REMOVE_SECOND_LEVEL_TAB':
      ...
      return {
        ...
        activeSecondLevelTab: state.activeSecondLevelTab?.id === action.payload
